<x-app-layout>
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Tambah Package Baru</h1>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.packages.store') }}" method="POST" class="bg-white rounded-xl shadow-lg p-8">
            @csrf
