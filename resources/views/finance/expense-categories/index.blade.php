<x-app-layout>
                            ...
                            @forelse($categories as $category)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                        ...
                                        <form action="{{ route('finance.expense-categories.destroy', $category) }}"
    ...
    <script>
        function openCreateModal() {
            ...
            document.getElementById('categoryForm').action = '{{ route('finance.expense-categories.store') }}';
        ...
        function openEditModal(id, name, description) {
            ...
            document.getElementById('categoryForm').action = `/finance/expense-categories/${id}`;
